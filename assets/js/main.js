...
document.getElementById("contactForm").addEventListener("submit", function (e) {
    ...
    const mailtoLink = `mailto:tanushac1811@gmail.com?subject=New Contact Form Message&body=Name: ${encodeURIComponent(name)}%0D%0AMessage: ${encodeURIComponent(message)}`;
